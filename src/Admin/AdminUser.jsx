        ...
        {userData.map((data, index) => (
          <div className="border border-r-2 w-[20vw] p-4" key={index}>
            ...
            <p className="text-gray-600 mb-2 flex">
              ...
              <p className="pl-1">Mobile Number: {data.mobileNumber}</p>
            </p>
            <p className="text-gray-600 mb-2 flex">
            ...
            <button className="p-3 border rounded ml-[4.5rem] mt-[2rem] bg-[#f85451] text-white font-semibold">Remove</button>
          </div>
        ))}
      </ul>
    </div>
