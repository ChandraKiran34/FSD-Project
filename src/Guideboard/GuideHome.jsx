...
function GuideHome() {
  ...
  return (
    <div className="bg-white p-4 rounded ">
      <h2 className="text-2xl font-semibold mb-4">Welcome, {guide.name}!</h2>
      ...
      <div className="flex items-center space-x-4">
        ...
        <div>
          <p className="flex gap-2"><FaLocationArrow className="mt-1"/>{guide.location}</p>
          <p className="flex gap-2"><MdEmail className="mt-1"/>{guide.email}</p>
